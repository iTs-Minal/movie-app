...
const Footer = () => {
  return (
    <footer
      className="bg-[linear-gradient(to_top,rgba(147,197,253,1),rgba(103,232,249,1))]
      dark:bg-[linear-gradient(to_top,rgba(107,114,128,0.9),rgba(71,85,105,0.3),rgba(31,41,55,0.9))]
      dark:text-white w-full text-black py-10 rounded-2xl"
    >
      <div className="container mx-auto px-4 flex flex-col items-center space-y-8">
        ...
        <div className="flex space-x-6">
          <a
            href="#"
            aria-label="Twitter"
            className="text-gray-900 dark:text-white hover:text-blue-500 transition-colors duration-300"
          >
            <FaTwitter size={28} />
          </a>
          <a
            ...
            className="text-gray-900 dark:text-white hover:text-pink-500 transition-colors duration-300"
          >
            <FaInstagram size={28} />
          </a>
          <a
            href="#"
            aria-label="GitHub"
            className="text-gray-900 dark:text-white hover:text-gray-500 transition-colors duration-300"
          >
            <FaGithub size={28} />
          </a>
          <a
            href="#"
            aria-label="LinkedIn"
            className="text-gray-900 dark:text-white hover:text-blue-700 transition-colors duration-300"
          >
            <FaLinkedin size={28} />
          </a>
        </div>
